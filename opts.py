...
class Opts:
	def __init__(self):
		...
		self.parser_train.add_argument('--epochs', default=40, type=int, help='epochs')
		self.parser_train.add_argument('--batch_size', default=100, type=int, help='batch size')

		self.parser_train.add_argument('--build_model', default='combined_multivariate', help='Type of model to build')
		...
		self.parser_train.add_argument('--verbose', default=0)
		...
		self.parser_evaluate.add_argument('--build_model', default='combined_multivariate', help='Type of model to build')
		...
		self.parser_experiment.add_argument('--exp_name', required=True, help='[defer_simulation, toy_regression, \
			clusterwise_ood, kl_mode, show_summary]')
		...
		self.parser_experiment.add_argument('--build_model', default='combined_multivariate', help='Type of model to build')

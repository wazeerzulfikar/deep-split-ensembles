...
def train_a_fold(model_type, x_train, y_train, x_val, y_val, model_dir, model_number, fold=1):
	...
	# 				epochs=epochs,
	# 				verbose=1,
	# 				callbacks=[checkpointer_nll, checkpointer_mse],
	...
	checkpoint_filepath = os.path.join(model_dir, model_type, 'model_nll_{}.h5'.format(model_number)) ########### CHANGE WHICH MODEL TO LOAD nll OR mse
...
Train NLLs:  [14.282050132751465, 77.93293762207031, 12.561100006103516, 18.796340942382812, 31.39078712463379, 46.58116912841797, 8.545112609863281,
12.856003761291504, 71.90215301513672, 17.82708740234375]
Val NLLs:  [35.391990661621094, 40.55481719970703, 35.220420837402344, 49.74131393432617, 47.220550537109375, 42.384586334228516, 29.60182762145996, 41.64630889892578, 53.02842330932617, 48.134132385253906]
Train NLL: 31.267 +/- 24.276
Val NLL: 42.292 +/- 7.009
Ensemble Val NLL calculated using ensemble distribution: 3.211
Deep ensemble of 10 models took 439 minutes
Bins:  [0.048, 0.049666666666666665, 0.051333333333333335, 0.053, 0.05466666666666667, 0.05633333333333333, 0.057999999999999996, 0.059666666666666666, 0.06133333333333334, 0.063]
Binned RMSEs:  [5.8050246, 5.8753147, 5.8753147, 5.8753147, 5.786303, 5.905477, 6.1474304, 6.4107223, 6.4358997, 8.176402]

Ensemble Preds:  [19.38856, 22.635103, 21.859533, 25.579487, 21.928595, 18.43546, 18.16982, 22.351635, 21.586094, 23.43073, 21.424358, 25.587948, 25.268469, 22.509325, 19.501879, 17.78042, 22.058098, 25.881222, 23.156685, 18.750782, 19.7925]
True Values:  [13.0, 30.0, 13.0, 29.0, 28.0, 14.0, 13.0, 30.0, 27.0, 16.0, 17.0, 29.0, 29.0, 18.0, 16.0, 28.0, 28.0, 27.0, 19.0, 11.0, 20.0]
Ensemble Pred Probs:  [0.05582445, 0.054150958, 0.06322117, 0.061267268, 0.05486005, 0.059257373, 0.060229704, 0.059347283, 0.059507243, 0.06333649, 0.056914087, 0.062241014, 0.05837194, 0.06214813, 0.057793405, 0.06067247, 0.05620588, 0.06033861, 0.048042748, 0.059946492, 0.056251235]
Ensemble Pred Log Probs:  [-2.8855433, -2.9159796, -2.761116, -2.7925096, -2.9029698, -2.825865, -2.8095896, -2.824349, -2.8216572, -2.7592936, -2.8662124, -2.776741, -2.84092, -2.7782345, -2.8508806, -2.8022652, -2.8787339, -2.8077831, -3.035664, -2.814303, -2.8779273]
Ensemble True Probs:  [0.03743594, 0.0328546, 0.023595318, 0.05337136, 0.038716074, 0.047696795, 0.044414718, 0.031066533, 0.042949628, 0.03158251, 0.04663459, 0.05401845, 0.05028893, 0.048559345, 0.05081519, 0.018132009, 0.039591767, 0.059480935, 0.04238549, 0.030424118, 0.056227162]
Ensemble True Log Probs:  [-3.285124, -3.4156635, -3.746707, -2.930481, -3.2515004, -3.042891, -3.1141844, -3.4716241, -3.1477273, -3.4551518, -3.0654128, -2.9184296, -2.9899702, -3.0249686, -2.97956, -4.0100765, -3.229134, -2.8220994, -3.1609492, -3.4925196, -2.8783553]
Ensemble val stddev:  [7.1463733, 7.3672247, 6.3102636, 6.5115066, 7.2720003, 6.732365, 6.62368, 6.7221646, 6.704097, 6.2987747, 7.009552, 6.409636, 6.8344865, 6.4192157, 6.902902, 6.575343, 7.0978746, 6.611725, 8.303901, 6.654973, 7.0921516]
Ensemble Val Entropy:  [3.3855433, 3.4159796, 3.261116, 3.2925096, 3.4029698, 3.325865, 3.3095896, 3.324349, 3.3216572, 3.2592936, 3.3662124, 3.276741, 3.34092, 3.2782345, 3.3508806, 3.3022652, 3.3787339, 3.3077831, 3.535664, 3.314303, 3.3779273]
Ensemble Val RMSE:  5.8050246
'''
